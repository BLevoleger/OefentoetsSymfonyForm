 ...
 */
class getBestellingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BestellingRepository' shared autowired service.
     *
     * @return \App\Repository\BestellingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BestellingRepository.php';

        return $container->privates['App\\Repository\\BestellingRepository'] = new \App\Repository\BestellingRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
